...
void app_main(){
    gpio_config_t dpy_config = {
        .intr_type = GPIO_INTR_DISABLE,
        .mode = GPIO_MODE_OUTPUT,
        .pin_bit_mask = (1ULL<<PIN_DPY_EN),
        .pull_down_en = 0,
        .pull_up_en = 0
    };
    gpio_config(&dpy_config);
    gpio_set_level(PIN_DPY_EN, 0);

    gpio_config_t bias_config = {
        .intr_type = GPIO_INTR_DISABLE,
        .mode = GPIO_MODE_OUTPUT,
        .pin_bit_mask = (1ULL<<PIN_BIAS_EN),
        .pull_down_en = 0,
        .pull_up_en = 0
    };
    gpio_config(&bias_config);
