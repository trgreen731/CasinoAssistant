...
static const gpio_num_t gpio_card_num[6] = {23, 22, 21, 19, 18, 5};
int new_flag = 0;
uint8_t card_in = 0x00;
char message[13] = "Card ID: 99\n";

void write_response(esp_spp_cb_param_t* param){
    if(new_flag){
        message[9] = '0' + (0xf0 & card_in);
        message[10] = '0' + (0x0f & card_in);
        new_flag = 0;
    }
    else{
        message[9] = 'x';
    ...
    esp_spp_write(param->data_ind.handle, MESS_LEN, &message);
}
...
void app_main(void)
{
    ...
    //setup interrupt and data for the RFID values
    gpio_config_t irq_config = {
        .intr_type = GPIO_INTR_HIGH_LEVEL,
        .mode = GPIO_MODE_INPUT,
        .pin_bit_mask = (1ULL<< GPIO_IRQ),
        .pull_down_en = 1,
        .pull_up_en = 0,
    };
    ...
    gpio_config_t d0_config = {
        ...
        .mode = GPIO_MODE_INPUT,
        .pin_bit_mask = (1ULL<< gpio_card_num[0]),
        .pull_down_en = 1,
        .pull_up_en = 0,
    };
    ...
    gpio_config_t d1_config = {
        .intr_type = GPIO_INTR_DISABLE,
        .mode = GPIO_MODE_INPUT,
        .pin_bit_mask = (1ULL<< gpio_card_num[1]),
        .pull_down_en = 1,
        .pull_up_en = 0,
    };
    ...
    gpio_config_t d2_config = {
        .intr_type = GPIO_INTR_DISABLE,
        .mode = GPIO_MODE_INPUT,
        .pin_bit_mask = (1ULL<< gpio_card_num[2]),
        .pull_down_en = 1,
        .pull_up_en = 0,
    };
    ...
    gpio_config_t d3_config = {
        .intr_type = GPIO_INTR_DISABLE,
        .mode = GPIO_MODE_INPUT,
        .pin_bit_mask = (1ULL<< gpio_card_num[3]),
        .pull_down_en = 1,
        .pull_up_en = 0,
    };
    ...
    gpio_config_t d4_config = {
        .intr_type = GPIO_INTR_DISABLE,
        .mode = GPIO_MODE_INPUT,
        .pin_bit_mask = (1ULL<< gpio_card_num[4]),
        .pull_down_en = 1,
        .pull_up_en = 0,
    };
    ...
    gpio_config_t d5_config = {
        .intr_type = GPIO_INTR_DISABLE,
        .mode = GPIO_MODE_INPUT,
        .pin_bit_mask = (1ULL<< gpio_card_num[5]),
        .pull_down_en = 1,
        .pull_up_en = 0,
    };
